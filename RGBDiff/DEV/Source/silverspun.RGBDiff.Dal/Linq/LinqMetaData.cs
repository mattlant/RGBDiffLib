...
namespace silverspun.RGBDiff.Dal.Linq
{
	...
	public partial class LinqMetaData : ILinqMetaData
	{
		...
		/// <summary>returns the datasource to use in a Linq query when targeting ControlSetEntity instances in the database.</summary>
		public DataSource<ControlSetEntity> ControlSet
		{
			get { return new DataSource<ControlSetEntity>(_transactionToUse, new ElementCreator(), _customFunctionMappings, _contextToUse); }
		}
		/// <summary>returns the datasource to use in a Linq query when targeting ControlSetColourEntity instances in the database.</summary>
		public DataSource<ControlSetColourEntity> ControlSetColour
		{
			get { return new DataSource<ControlSetColourEntity>(_transactionToUse, new ElementCreator(), _customFunctionMappings, _contextToUse); }
		}
		/// <summary>returns the datasource to use in a Linq query when targeting ObserverDataSetEntity instances in the database.</summary>
		public DataSource<ObserverDataSetEntity> ObserverDataSet
		{
			get { return new DataSource<ObserverDataSetEntity>(_transactionToUse, new ElementCreator(), _customFunctionMappings, _contextToUse); }
		}
		/// <summary>returns the datasource to use in a Linq query when targeting ObserverDataSetColourEntity instances in the database.</summary>
		public DataSource<ObserverDataSetColourEntity> ObserverDataSetColour
		{
			get { return new DataSource<ObserverDataSetColourEntity>(_transactionToUse, new ElementCreator(), _customFunctionMappings, _contextToUse); }
		}
