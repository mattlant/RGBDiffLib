...
namespace silverspun.RGBDiff.Dal.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the ControlSet Entity. It will perform database oriented actions for
	/// a entity of type 'ControlSetEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class ControlSetDAO : DaoBase
	{
		...
		internal ControlSetDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves entities of the type 'ControlSetEntity' in a datatable which match the specified filter. 
